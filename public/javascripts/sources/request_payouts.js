import { creator_tip_history_load } from './tip_history.js';
...
function request_payout_function() {
    ...
    request_payout_button.on('click', function(e) {
        ...
        xhr.done(function(response) {
            ...
            toastr.success("Your payment request has been recorded.");
        });
